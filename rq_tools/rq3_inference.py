...
from opencood.rq_eval.v2x_gen_utils import get_valid_param_dict
...
def main():
    ...
    if opt.method == 'ori':
        ...
        yaml_path = os.path.join(opt.model_dir, 'config.yaml')
    ...
    if opt.fusion_method == 'nofusion':
        ...
        for i, batch_data in enumerate(data_loader):
            with torch.no_grad():
                ...
                # print(type(pred_box_tensor), type(pred_score), type(gt_box_tensor))
