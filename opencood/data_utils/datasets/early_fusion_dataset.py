...
from opencood.rq_eval.v2x_gen_utils import get_v2x_gen_dict
...
class EarlyFusionDataset(basedataset.BaseDataset):
    ...
    def __getitem__(self, idx):
        ...
        for cav_id, selected_cav_base in base_data_dict.items():
            ...
            # TODO: add occlusion rate and distance for each object_id (early_fusion_dataset)
            if cav_id == '0':
                processed_data_dict['ego'].update({'v2x_gen': selected_cav_processed['v2x_gen']})
            else:
                processed_data_dict['ego'].update({'v2x_gen_cp': selected_cav_processed['v2x_gen']})
    ...
    def get_item_single_car(self, selected_cav_base, ego_pose):
        ...
        # TODO: add occlusion rate and distance for each object_id (early_fusion_dataset)
        v2x_gen_dict = get_v2x_gen_dict(selected_cav_base)
        selected_cav_processed.update({'v2x_gen': v2x_gen_dict})
    ...
    def collate_batch_test(self, batch):
        ...
        for cav_id, cav_content in batch.items():
            ...
            if 'v2x_gen_cp' in cav_content:
                v2x_gen_cp = cav_content['v2x_gen_cp']
            else:
                v2x_gen_cp = {}
            ...
            output_dict[cav_id].update({'object_bbx_center': object_bbx_center,
                                        ...
                                        'v2x_gen': cav_content['v2x_gen'],
                                        'v2x_gen_cp': v2x_gen_cp
                                        })
    ...
    def post_process(self, data_dict, output_dict):
        ...
        gt_box_tensor, gt_label_tensor, gt_object_ids = self.post_processor.generate_gt_bbx(data_dict)

        return pred_box_tensor, pred_score, gt_box_tensor, gt_label_tensor, gt_object_ids
