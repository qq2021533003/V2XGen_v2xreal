...
class LateFusionDataset(basedataset.BaseDataset):
    ...
    def get_item_single_car(self, selected_cav_base):
        ...
        selected_cav_processed.update({'vehicles_info': vehicles_info})
    ...
    def collate_batch_test(self, batch):
        ...
        for cav_id, cav_content in batch.items():
            ...
            # NOTE: 改动代码
            # 添加遮挡率和距离信息
            v2x_gen_dict = cav_content.get('v2x_gen', {})
    ...
    def post_process(self, data_dict, output_dict):
        ...
        """
        # print(data_dict['ego']['object_ids'], data_dict['ego']['inserted_ids'])
    ...
    def post_process_cp(self, data_dict, output_dict):
            ...
            gt_box_tensor, gt_label_tensor, gt_object_ids = self.post_processor.generate_cp_gt_bbx(data_dict)
